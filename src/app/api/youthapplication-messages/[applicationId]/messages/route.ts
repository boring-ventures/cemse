...
export async function GET(
  ...
  try {
    ...
    console.log(
      "🔍 YouthApplicationMessages - Fetching messages for application:",
      applicationId
    );
    ...
    console.log(
      "🔍 YouthApplicationMessages - Found",
      messages.length,
      "messages"
    );

    // Return in the same format as the working system
    return NextResponse.json({
      messages,
      pagination: {
    ...
    console.error("Error in youth application messages route:", error);
    return NextResponse.json(
